...
Missing, stale, or contradictory generated outputs are valid audit findings, but the fix path should point back to `scripts/codex/catalog.json` plus `scripts/skills-packaging.sh sync-repo`, not direct manual edits.
